...
img_width = 160
img_height = 120
filename_pattern = r'(?P<control>(a)\d)_\d\d?\d?.png'
output_pattern = {
    'a0': [1, 0, 0, 0, 0], # Full right
    'a1': [0, 1, 0, 0, 0], # Half right
    'a2': [0, 0, 1, 0, 0], # Straightforward
    'a3': [0, 0, 0, 1, 0], # Half left
    'a4': [0, 0, 0, 0, 1]  # Full left
}
output_labels = [
    'Full right', 
    'Half right', 
